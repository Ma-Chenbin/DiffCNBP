...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None,
        ...
        if input_nc is None:
            input_nc = outer_nc
        downconv = nn.Conv1d(input_nc, kernel_size=4,
        ...
        if outermost:
            upconv = nn.ConvTranspose1d(inner_nc * 2,
            ...
            upconv = nn.ConvTranspose1d(inner_nc,
                                        kernel_size=4, stride=2,
...
class PixelDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, norm_layer=nn.BatchNorm1d):
        ...
        self.net = [
            nn.Conv1d(input_nc, kernel_size=1, stride=1, padding=0),
            nn.LeakyReLU(0.2, True),
            nn.Conv1d(ndf, kernel_size=1, stride=1, padding=0, bias=use_bias),
            norm_layer(ndf * 2),
            nn.LeakyReLU(0.2, True),
            nn.Conv1d(ndf * 2, kernel_size=1, stride=1, padding=0, bias=use_bias)]
